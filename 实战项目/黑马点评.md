...
![image-20250527155624482](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250527155624482.png)
...
![image-20250430130921828](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430130921828.png)
...
![image-20250430131421290](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430131421290.png)
...
![image-20250430132823591](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430132823591.png)
...
![image-20250430140027720](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430140027720.png)

![image-20250430140041161](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430140041161.png)
...
![image-20250430161730294](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430161730294.png)
...
![image-20250430161755325](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250430161755325.png)
...
![image-20250501153534230](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501153534230.png)
...
![image-20250501153943970](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501153943970.png)
...
![image-20250501155248960](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501155248960.png)

对于新型的Feed流的的效果：不需要我们用户再去推送信息，而是系统分析用户到底想要什么，然后直接把内容推送给用户，从而使用户能够更加的节约时间，不用主动去寻

![image-20250501155300730](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501155300730.png)
...
![image-20250501155347041](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501155347041.png)
...
![image-20250501155400060](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501155400060.png)

**推拉结合模式**：也叫做读写混合，兼具推和拉两种模式的优点

推拉模式是一个折中的方案，站在发件人这一端，如果是个普通的人，那么我们采用写扩散的方式，直接把数据写入到他的粉丝中去，因为普通的人他的粉丝关注量比较小，所以这样做没有压力，如果是大V，那么他是直接将数据先写入到一份到发件箱里边去，然后再直接写一份到活跃粉丝收件箱里边去，现在站在收件人这端来看，如果是活跃粉丝，那么大V和普通的人发的都会直接写入到自己收件箱里边来，而如果是普通的粉丝，由于他们上线不是很频繁，所以等他们上线时，再从发件箱里边去拉信息

![image-20250501155413992](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501155413992.png)

![image-20250501160144260](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501160144260.png)
...
![image-20250501160733985](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501160733985.png)
...
![image-20250501160814552](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501160814552.png)
...
![image-20250501161927560](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501161927560.png)
...
![image-20250501165213130](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501165213130.png)

当我们点击美食之后，会出现一系列的商家，商家中可以按照多种排序方式，我们此时关注的是距离，这个地方就需要使用到我们的GEO，向后台传入当前app收集的地址(我们此处是写死的) ，以当前坐标作为圆心，同时绑定相同的店家类型type，以及分页信息，把这几个条件传入后台，后台查询出对应的数据再返回

![image-20250501165221515](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501165221515.png)
...
![image-20250501213015414](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501213015414.png)
...
![image-20250501213111921](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501213111921.png)
...
获得当前这个月的最后一次签到数据，定义一个计数器，然后不停的向前统计，直到获得第一个非0的数字即可，每得到一个非0的数字计数器+1，直到遍历完所有的数据，就可以获得当前月的签到总天数

需求：实现下面接口，统计当前用户截止当前时间在本月的连续签到天数

![image-20250501215002685](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501215002685.png)
...
![image-20250501215816129](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501215816129.png)
...
![image-20250501220110313](https://picgo-zjp.oss-cn-shenzhen.aliyuncs.com/image-20250501220110313.png)
